        ...
        <section className="event_banner_area" id="home">
            ...
            <div className="container">
                <div className="event_banner_content">
                    ...
                    <a className="event_btn event_btn_banner event_btn_two btn_hover wow fadeInRight" data-wow-delay="0.9s" href="https://www.youtube.com/watch?v=S719j6wChh0" target="_blank"><i className="arrow_triangle-right_alt2"></i>Conheça</a>
                </div>
            </div>
        </section>
    )
